        ...
        if (empty($errors)) {
            try {
                $stmt = $pdo->prepare("
                    ...
                    (bank_name, account_holder_name, account_number, routing_number, swift_bic_code, 
                     bank_address, account_type, currency, country, instructions, logo_path, 
                ...
                <div class="flex items-start">
                    ...
                    <div class="text-sm text-blue-800">
                        ...
                        <ul class="list-disc list-inside space-y-1 text-blue-700">
                            <li>Double-check account numbers to prevent payment errors</li>
                            <li>Include routing number for US domestic transfers</li>
                            <li>Add SWIFT/BIC code for international transfers</li>
                            <li>Provide clear instructions about processing times</li>
                            <li>Specify account holder name exactly as it appears on the account</li>
                        </ul>
                    </div>
                </div>
            </div>
