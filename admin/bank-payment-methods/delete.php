                    ...
                    <div class="p-6">
                        ...
                        <div class="mb-6 p-4 bg-gray-50 rounded-lg border border-gray-200">
                            <div class="flex items-center space-x-4">
                                ...
                                <?php else: ?>
                                    <div class="w-16 h-16 rounded-full bg-gradient-to-br from-green-500 to-blue-500 flex items-center justify-center text-white font-bold text-2xl">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="text-gray-600">
                                        ...
                                        <code class="text-xs bg-gray-200 px-2 py-1 rounded"><?= truncate(e($bank_method['account_number']), 20) ?></code>
                                    </p>
                                    <?php if ($bank_method['currency']): ?>
                                        <p class="text-sm text-gray-500 mt-1">
                                            Currency: <?= e($bank_method['currency']) ?>
                            ...
                            <div class="flex items-start">
                                ...
                                <div>
                                    ...
                                    <ul class="list-disc list-inside text-red-700 text-sm space-y-1">
                                        ...
                                        <li>Delete associated logo image if exists</li>
                                        <?php if ($link_count > 0): ?>
                            ...
                            <div class="grid grid-cols-2 gap-3 text-sm">
                                ...
                                <?php if ($bank_method['routing_number']): ?>
                                    <div>
                                        ...
                                        <code class="text-gray-800 font-medium ml-2 text-xs"><?= e($bank_method['routing_number']) ?></code>
                                    </div>
                                <?php endif; ?>
                                <?php if ($bank_method['swift_bic_code']): ?>
                                    <div>
                                        <span class="text-gray-600">SWIFT/BIC:</span>
                                        <code class="text-gray-800 font-medium ml-2 text-xs"><?= e($bank_method['swift_bic_code']) ?></code>
                                    </div>
                                <?php endif; ?>
                                <div>
                    ...
                    <div class="flex items-start">
                        ...
                        <div class="text-sm text-blue-800">
                            ...
                            <ul class="list-disc list-inside space-y-1 text-blue-700">
                                <li>If you want to temporarily hide this bank method, you can <a href="edit.php?id=<?= $id ?>" class="underline font-medium">deactivate it instead</a></li>
