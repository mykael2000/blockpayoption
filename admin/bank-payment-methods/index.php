...
$bank_methods = getBankPaymentMethods(false);
        ...
        <main class="flex-1 p-8">
            ...
            <div class="mb-8 flex items-center justify-between">
                <div>
                    ...
                    <p class="text-gray-600 mt-2">Manage bank account payment options</p>
                </div>
                <a href="create.php" class="bg-gradient-to-r from-green-600 to-blue-600 hover:from-green-700 hover:to-blue-700 text-white px-6 py-3 rounded-lg font-medium shadow-lg transform hover:scale-105 transition duration-200">
                    + Add Bank Method
                </a>
            </div>
            ...
            <?php if (empty($bank_methods)): ?>
                <div class="bg-white rounded-xl shadow-lg p-12 text-center">
                    ...
                    <a href="create.php" class="inline-block bg-gradient-to-r from-green-600 to-blue-600 hover:from-green-700 hover:to-blue-700 text-white px-6 py-3 rounded-lg font-medium shadow-lg transition duration-200">
            ...
            <?php else: ?>
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full">
                            <thead class="bg-gradient-to-r from-gray-50 to-gray-100 border-b-2 border-gray-200">
                                <tr>
                                    <th class="text-left py-4 px-6 text-sm font-bold text-gray-700 uppercase tracking-wider">Bank Name</th>
                                    <th class="text-left py-4 px-6 text-sm font-bold text-gray-700 uppercase tracking-wider">Account Holder</th>
                                    <th class="text-left py-4 px-6 text-sm font-bold text-gray-700 uppercase tracking-wider">Account Number</th>
                                    <th class="text-left py-4 px-6 text-sm font-bold text-gray-700 uppercase tracking-wider">Currency</th>
                            ...
                            <tbody class="divide-y divide-gray-200">
                                <?php foreach ($bank_methods as $method): ?>
                                    <tr class="hover:bg-gradient-to-r hover:from-green-50 hover:to-blue-50 transition duration-150">
                                        <td class="py-4 px-6">
                                            <div class="flex items-center space-x-3">
                                                ...
                                                <?php else: ?>
                                                    <div class="w-10 h-10 rounded-full bg-gradient-to-br from-green-500 to-blue-500 flex items-center justify-center text-white font-bold text-lg">
                                                        🏦
                                                    </div>
                                                <?php endif; ?>
                                                <div>
                                        ...
                                        <td class="py-4 px-6">
                                            ...
                                            <div class="text-xs text-gray-500"><?= e(ucfirst($method['account_type'])) ?> Account</div>
                                        </td>
                                        <td class="py-4 px-6">
                                        ...
                                        <td class="py-4 px-6">
                                            <code class="bg-gradient-to-r from-green-100 to-blue-100 text-green-800 px-3 py-1 rounded-full text-sm font-semibold">
                                                <?= e($method['currency']) ?>
                                            </code>
                                        </td>
                ...
                <!-- Statistics Footer -->
                <div class="mt-6 bg-gradient-to-r from-green-100 to-blue-100 rounded-lg p-4 border border-green-200">
