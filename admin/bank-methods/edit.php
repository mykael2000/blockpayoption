...
$form_data = [
    ...
    'swift_code' => $bank_method['swift_code'],
    'iban' => $bank_method['iban'],
                ...
                <div class="flex items-start">
                    ...
                    <div class="text-sm text-emerald-800">
                        ...
                        <ul class="list-disc list-inside space-y-1 text-emerald-700">
                            ...
                            <li>Changing display order affects how bank methods appear to customers</li>
                            <li>Deactivating a bank method hides it from customers but preserves all data</li>
                            <li>Ensure all banking information remains accurate and up to date</li>
                        </ul>
                    </div>
                </div>
            </div>
